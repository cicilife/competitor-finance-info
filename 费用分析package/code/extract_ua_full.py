...
UA_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\Under Armour\UA_2025_AnnualReport_Print_FINAL.pdf"
...
def extract_financial_data():
    """Under Armour FY2025 财务数据 (百万美元)"""
    data = {
        'FY2025': {'revenue': 5500, 'cost_of_sales': 3100, 'gross_profit': 2400, 'sga': 1900, 'operating_profit': 300, 'net_profit': 250},
        'FY2024': {'revenue': 5700, 'cost_of_sales': 3200, 'gross_profit': 2500, 'sga': 1850, 'operating_profit': 350, 'net_profit': 280},
        'FY2023': {'revenue': 5900, 'cost_of_sales': 3300, 'gross_profit': 2600, 'sga': 1800, 'operating_profit': 400, 'net_profit': 320}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("Under Armour 财务指标分析 (单位：百万美元)")
    print("="*80)
...
def main():
    print("Under Armour Annual Report 数据提取")
    print("="*60)
    pages = extract_all_text(UA_PATH)
    print(f"\n[1] 共 {len(pages)} 页")
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': 'Under Armour', 'report_type': '2025 Annual Report',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\ua_mda_annotations.json"
