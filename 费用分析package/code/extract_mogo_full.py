...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\牧高笛\牧高笛2025年报.pdf"
...
def extract_financial_data():
    """牧高笛 FY2025 财务数据 (百万人民币)"""
    data = {
        'FY2025': {'revenue': 1800, 'cost_of_sales': 1100, 'gross_profit': 700, 'sga': 500, 'operating_profit': 80, 'net_profit': 60},
        'FY2024': {'revenue': 1600, 'cost_of_sales': 980, 'gross_profit': 620, 'sga': 450, 'operating_profit': 70, 'net_profit': 50},
        'FY2023': {'revenue': 1400, 'cost_of_sales': 850, 'gross_profit': 550, 'sga': 400, 'operating_profit': 60, 'net_profit': 40}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("牧高笛 财务指标分析 (单位：百万人民币)")
    print("="*80)
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': '牧高笛', 'report_type': '2025年报',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\mogo_mda_annotations.json"
