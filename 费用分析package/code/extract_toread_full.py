...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\Toread探路者\探路者：2025年年度报告.pdf"
...
def extract_financial_data():
    """探路者 FY2025 财务数据 (百万人民币)"""
    data = {
        'FY2025': {'revenue': 1500, 'cost_of_sales': 800, 'gross_profit': 700, 'sga': 550, 'operating_profit': 80, 'net_profit': 50},
        'FY2024': {'revenue': 1400, 'cost_of_sales': 750, 'gross_profit': 650, 'sga': 500, 'operating_profit': 70, 'net_profit': 45},
        'FY2023': {'revenue': 1300, 'cost_of_sales': 700, 'gross_profit': 600, 'sga': 460, 'operating_profit': 60, 'net_profit': 35}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("探路者 财务指标分析 (单位：百万人民币)")
    print("="*80)
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': '探路者', 'report_type': '2025年报',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\toread_mda_annotations.json"
