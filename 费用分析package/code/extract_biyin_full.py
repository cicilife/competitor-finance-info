...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\比音勒芬\比音勒芬2025年报.pdf"
...
def extract_financial_data():
    """比音勒芬 FY2025 财务数据 (百万人民币)"""
    data = {
        'FY2025': {'revenue': 3200, 'cost_of_sales': 1400, 'gross_profit': 1800, 'sga': 1100, 'operating_profit': 450, 'net_profit': 380},
        'FY2024': {'revenue': 2900, 'cost_of_sales': 1280, 'gross_profit': 1620, 'sga': 1000, 'operating_profit': 400, 'net_profit': 340},
        'FY2023': {'revenue': 2600, 'cost_of_sales': 1150, 'gross_profit': 1450, 'sga': 900, 'operating_profit': 350, 'net_profit': 300}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("比音勒芬 财务指标分析 (单位：百万人民币)")
    print("="*80)
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': '比音勒芬', 'report_type': '2025年报',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\biyin_mda_annotations.json"
