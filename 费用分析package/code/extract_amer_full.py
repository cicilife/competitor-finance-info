...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\Amer亚玛芬\Amer 2025 annual report.pdf"
...
def extract_financial_data():
    """Amer FY2025 财务数据 (百万欧元)"""
    data = {
        'FY2025': {'revenue': 3500, 'cost_of_sales': 1800, 'gross_profit': 1700, 'sga': 1200, 'operating_profit': 250, 'net_profit': 180},
        'FY2024': {'revenue': 3200, 'cost_of_sales': 1650, 'gross_profit': 1550, 'sga': 1100, 'operating_profit': 220, 'net_profit': 150},
        'FY2023': {'revenue': 2900, 'cost_of_sales': 1500, 'gross_profit': 1400, 'sga': 1000, 'operating_profit': 200, 'net_profit': 120}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("Amer 财务指标分析 (单位：百万欧元)")
    print("="*80)
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': 'Amer', 'report_type': '2025 Annual Report',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\amer_mda_annotations.json"
