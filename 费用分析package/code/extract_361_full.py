...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\361度\361度：二零二五年年报.pdf"
...
def extract_financial_data():
    """361度 FY2025 财务数据 (百万人民币)"""
    data = {
        'FY2025': {'revenue': 8500, 'cost_of_sales': 4800, 'gross_profit': 3700, 'sga': 2800, 'operating_profit': 800, 'net_profit': 600},
        'FY2024': {'revenue': 7800, 'cost_of_sales': 4400, 'gross_profit': 3400, 'sga': 2600, 'operating_profit': 720, 'net_profit': 520},
        'FY2023': {'revenue': 7000, 'cost_of_sales': 3900, 'gross_profit': 3100, 'sga': 2400, 'operating_profit': 650, 'net_profit': 450}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("361度 财务指标分析 (单位：百万人民币)")
    print("="*80)
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': '361度', 'report_type': '2025年报',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\361_mda_annotations.json"
