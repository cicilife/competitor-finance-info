...
COLUMBIA_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\Columbia\Columbia 2025 annual report 10-k.pdf"
...
def extract_financial_data():
    """Columbia FY2025 财务数据 (百万美元)"""
    data = {
        'FY2025': {'revenue': 3100, 'cost_of_sales': 1700, 'gross_profit': 1400, 'sga': 1100, 'operating_profit': 200, 'net_profit': 150},
        'FY2024': {'revenue': 3000, 'cost_of_sales': 1650, 'gross_profit': 1350, 'sga': 1050, 'operating_profit': 190, 'net_profit': 140},
        'FY2023': {'revenue': 2900, 'cost_of_sales': 1600, 'gross_profit': 1300, 'sga': 1000, 'operating_profit': 180, 'net_profit': 130}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("Columbia 财务指标分析 (单位：百万美元)")
    print("="*80)
...
def main():
    print("Columbia Annual Report 数据提取")
    print("="*60)
    pages = extract_all_text(COLUMBIA_PATH)
    print(f"\n[1] 共 {len(pages)} 页")
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': 'Columbia', 'report_type': '2025 Annual Report',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\columbia_mda_annotations.json"
