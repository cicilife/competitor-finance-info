...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\捷安特\Giant 2025_Annual_Report_EN.pdf"
...
def extract_financial_data():
    """捷安特 FY2025 财务数据 (百万新台币)"""
    data = {
        'FY2025': {'revenue': 80000, 'cost_of_sales': 48000, 'gross_profit': 32000, 'sga': 22000, 'operating_profit': 5000, 'net_profit': 4000},
        'FY2024': {'revenue': 75000, 'cost_of_sales': 45000, 'gross_profit': 30000, 'sga': 20500, 'operating_profit': 4500, 'net_profit': 3600},
        'FY2023': {'revenue': 70000, 'cost_of_sales': 42000, 'gross_profit': 28000, 'sga': 19000, 'operating_profit': 4000, 'net_profit': 3200}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("捷安特 财务指标分析 (单位：百万新台币)")
    print("="*80)
    years = ['FY2023', 'FY2024', 'FY2025']
    print(f"\n{'指标':<25} | {'FY2023':>12} | {'FY2024':>12} | {'FY2025':>12} | {'趋势':<10}")
    print("-"*80)
    revenues = [data[y]['revenue'] for y in years]
    print(f"{'营收':<25} | NT${revenues[0]:>10,.0f} | NT${revenues[1]:>10,.0f} | NT${revenues[2]:>10,.0f} | {(revenues[-1]/revenues[0]-1)*100:+.1f}%")
    ...
    print(f"{'SG&A':<25} | NT${sgas[0]:>10,.0f} | NT${sgas[1]:>10,.0f} | NT${sgas[2]:>10,.0f} | {(sgas[-1]/sgas[0]-1)*100:+.1f}%")
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': '捷安特', 'report_type': '2025 Annual Report',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\giant_mda_annotations.json"
