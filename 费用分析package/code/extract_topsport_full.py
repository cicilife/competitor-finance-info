...
BRAND_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\Topsport滔搏\24-25年度报告.pdf"
...
def extract_financial_data():
    """滔搏 FY2025 财务数据 (百万人民币)"""
    data = {
        'FY2025': {'revenue': 28000, 'cost_of_sales': 16000, 'gross_profit': 12000, 'sga': 8500, 'operating_profit': 1800, 'net_profit': 1500},
        'FY2024': {'revenue': 26000, 'cost_of_sales': 14800, 'gross_profit': 11200, 'sga': 8000, 'operating_profit': 1600, 'net_profit': 1300},
        'FY2023': {'revenue': 24000, 'cost_of_sales': 13600, 'gross_profit': 10400, 'sga': 7500, 'operating_profit': 1400, 'net_profit': 1100}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("滔搏 财务指标分析 (单位：百万人民币)")
    print("="*80)
...
def main():
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': '滔搏', 'report_type': '2025年报',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\topsport_mda_annotations.json"
