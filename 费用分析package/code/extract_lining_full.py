...
LI_NING_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\李宁\李宁：2025年度报告.pdf"
...
KEYWORD_DICT = {
    'expense_types': {
        ...
        'operating_expense': ['经营', '運營', '營運', '经营费用'],
        'personnel': ['員工', '人工', '薪酬', '福利', '员工成本'],
        'technology': ['技术', '科技', '數字化', 'IT', '信息'],
        'logistics': ['物流', '倉儲', '供應鏈', '库存'],
        'marketing_digital': ['电商', '電子商務', 'DTC', '線上', '數字營銷'],
        'real_estate': ['门店', '店舖', '零售', '租賃', '店舖租金']
    },
    'trends': {
        'increase': ['增长', '上升', '增加', '提升', '提高', '同比', '上升'],
        'decrease': ['下降', '減少', '下滑', '降低', '下降', '減少'],
        'stable': ['稳定', '持平', '保持', '相若', '平稳'],
        'new': ['新增', '新開', '新建', '首次', '新店']
    },
    'drivers': {
        'business_expansion': ['扩张', '擴張', '增長', '規模', '市場份額', '國際化', '海外'],
        'investment': ['投资', '投資', '投入', '戰略', '资本开支'],
        'efficiency': ['效率', '提效', '優化', '成本管控', '精细化管理', '节约'],
        'dtc_transformation': ['DTC', '直營', '電商', '線上渠道', '會員', '零售'],
        'brand_building': ['品牌', '品牌建設', '品牌價值', '品牌形象', '品牌升级'],
        'product_innovation': ['创新', '創新', '產品創新', '研發', '專業產品', '产品力'],
        'supply_chain': ['供应链', '供應鏈', '物流', '採購', '庫存', '供应商'],
        'external': ['宏观', '經濟環境', '匯率', '監管', '政策', '市場波動', '经济']
    }
}
...
def extract_sentiment(text):
    positive_words = ['增长', '提升', '提高', '改善', '成功', '强劲', '优异', '超预期', '突破', '显著']
    negative_words = ['下降', '減少', '下滑', '亏损', '虧損', '挑战', '困難', '壓力', '風險', '下滑']
...
def main():
    print("李宁 2025年度报告 数据提取")
    print("="*60)

    pages = extract_all_text(LI_NING_PATH)
    print(f"\n[1] 共 {len(pages)} 页")
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\lining_mda_annotations.json"
