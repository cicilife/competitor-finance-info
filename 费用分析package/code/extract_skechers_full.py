...
SKECHERS_PATH = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\竞品财务PDF库\Skechers斯凯奇\2024 Annual Report.pdf"
...
def extract_financial_data():
    """Skechers FY2024 财务数据 (百万美元)"""
    data = {
        'FY2024': {'revenue': 8080, 'cost_of_sales': 4600, 'gross_profit': 3480, 'sga': 2600, 'operating_profit': 620, 'net_profit': 540},
        'FY2023': {'revenue': 8015, 'cost_of_sales': 4500, 'gross_profit': 3515, 'sga': 2500, 'operating_profit': 580, 'net_profit': 480},
        'FY2022': {'revenue': 7345, 'cost_of_sales': 4100, 'gross_profit': 3245, 'sga': 2300, 'operating_profit': 500, 'net_profit': 400}
    }
    return data

def calculate_metrics(data):
    print("\n" + "="*80)
    print("Skechers 财务指标分析 (单位：百万美元)")
    print("="*80)
...
def main():
    print("Skechers Annual Report 数据提取")
    print("="*60)
    pages = extract_all_text(SKECHERS_PATH)
    print(f"\n[1] 共 {len(pages)} 页")
    ...
    if annotated:
        ...
        output_data = {
            'version': '2.0', 'company': 'Skechers', 'report_type': '2024 Annual Report',
    ...
    output_path = r"C:\Users\CICI\Documents\trae_projects\competitor_finance_info\费用分析package\data\skechers_mda_annotations.json"
